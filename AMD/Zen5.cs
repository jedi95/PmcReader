...
namespace PmcReader.AMD
{
    public class Zen5 : Amd19hCpu
    {
        public Zen5()
        {
            ...
            {
                new Zen5TopDown(this),
                new Zen5TDFrontend(this),
                new Zen5TDBackend(this),
        ...
        public class Zen5TopDown : MonitoringConfig
        {
            private Zen5 cpu;
            public string GetConfigName() { return "Top Down, Dispatch"; }

            public Zen5TopDown(Zen5 amdCpu) { cpu = amdCpu; }
            ...
            {
                float slots = counterData.aperf * 8;
        ...
        public class Zen5TDFrontend : MonitoringConfig
        {
            private Zen5 cpu;
            public string GetConfigName() { return "Top Down, Frontend"; }

            public Zen5TDFrontend(Zen5 amdCpu) { cpu = amdCpu; }
            ...
            private string[] computeMetrics(string label, NormalizedCoreCounterData counterData)
            {
                ...
                float decoderOps = counterData.ctr1;
                float retiredOps = counterData.ctr2;
                float frontendBoundCmask8 = counterData.ctr3;
                ...
                return new string[] { label,
                        ...
                        string.Format("{0:F2}", counterData.instr / counterData.aperf),
                        FormatPercentage(frontendBoundSlots, slots),
                        FormatPercentage(8 * frontendBoundCmask8, slots),
                        FormatPercentage(frontendBoundSlots - 8 * frontendBoundCmask8, slots),
                        FormatPercentage(decoderOps - retiredOps, slots),
        ...
        public class Zen5TDBackend : MonitoringConfig
        {
            private Zen5 cpu;
            public string GetConfigName() { return "Top Down, Backend Retire"; }

            public Zen5TDBackend(Zen5 amdCpu) { cpu = amdCpu; }
        ...
        public class BpuMonitoringConfig : MonitoringConfig
        {
            ...
            public BpuMonitoringConfig(Zen5 amdCpu) { cpu = amdCpu; }
        ...
        public class FlopsConfig : MonitoringConfig
        {
            ...
            public FlopsConfig(Zen5 amdCpu) { cpu = amdCpu; }
        ...
        public class VecIntConfig : MonitoringConfig
        {
            ...
            public VecIntConfig(Zen5 amdCpu) { cpu = amdCpu; }
        ...
        public class FpOpWidthConfig : MonitoringConfig
        {
            ...
            public FpOpWidthConfig(Zen5 amdCpu) { cpu = amdCpu; }
        ...
        public class FetchConfig : MonitoringConfig
        {
            ...
            public FetchConfig(Zen5 amdCpu) { cpu = amdCpu; }
            ...
            public string[] columns = new string[] { "Item", "Active Cycles", "Instructions", "IPC", "Op$ Hitrate", "Op$ MPKI", "L1i Hitrate", "L1i MPKI", "iTLB Hitrate", "iTLB MPKI", "L2 iTLB Hitrate", "L2 iTLB MPKI" };
            ...
            private string[] computeMetrics(string label, NormalizedCoreCounterData counterData)
            {
                return new string[] { label,
                        ...
                        FormatPercentage(counterData.ctr2 - counterData.ctr4, counterData.ctr2), // L1i access - iTLB miss (hits) / L1i access
        ...
        public class LoopBufferConfig : MonitoringConfig
        {
            ...
            public LoopBufferConfig(Zen5 amdCpu) { cpu = amdCpu; }
        ...
        public class TlbConfig : MonitoringConfig
        {
            ...
            public TlbConfig(Zen5 amdCpu) { cpu = amdCpu; }
            ...
            public string[] columns = new string[] { "Item", "Active Cycles", "Instructions", "IPC", "L1 TLB Hitate", "L1 TLB MPKI", "L2 TLB Hitrate", "L2 TLB MPKI" };
            ...
            private string[] computeMetrics(string label, NormalizedCoreCounterData counterData)
            {
                return new string[] { label,
                        ...
                        FormatLargeNumber(counterData.instr),
                        string.Format("{0:F2}", counterData.instr / counterData.aperf),
                        FormatPercentage(counterData.ctr3 - counterData.ctr0, counterData.ctr3), // LS dispatch - DTLB miss (hits) / LS dispatch
        ...
        public class LocksConfig : MonitoringConfig
        {
            ...
            public LocksConfig(Zen5 amdCpu) { cpu = amdCpu; }
        ...
        public class SwPrefetchConfig : MonitoringConfig
        {
            ...
            public SwPrefetchConfig(Zen5 amdCpu) { cpu = amdCpu; }
        ...
        public class DCFillConfig : MonitoringConfig
        {
            ...
            public DCFillConfig(Zen5 amdCpu) { cpu = amdCpu; }
        ...
        public class DispatchStallConfig : MonitoringConfig
        {
            ...
            public DispatchStallConfig(Zen5 amdCpu) { cpu = amdCpu; }
        ...
        public class DispatchStallConfig1 : MonitoringConfig
        {
            ...
            public DispatchStallConfig1(Zen5 amdCpu) { cpu = amdCpu; }
        ...
        public class L2Config : MonitoringConfig
        {
            ...
            public L2Config(Zen5 amdCpu) { cpu = amdCpu; }
        ...
        public class MABOccupancyConfig : MonitoringConfig
        {
            ...
            public MABOccupancyConfig(Zen5 amdCpu) { cpu = amdCpu; }
